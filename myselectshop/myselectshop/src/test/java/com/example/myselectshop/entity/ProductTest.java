...
class ProductTest {
    ...
    @Nested // Test코드를 다 작성 후 확인할 때 눈에 잘보일 수 있게 안으로 들어가게 해주는 부분.
    ...
    class CreateUserProduct {
        ...
        @BeforeEach
            // Given 부분. 우리가 Test하는데 필요한 부분을 미리 준다.
        void setup() {
            userId = 100L;
        ...
        class FailCases {
            ...
            class userId {
                ...
                void fail1() {
                    ...
                    // then
                    assertEquals("회원 Id 가 유효하지 않습니다.", exception.getMessage()); // expected 메세지도 정확히 동일해야 test가 실행된다.
                }
